...
class AzureSpeechService {
    ...
    func chatWithGPT4(messages: [ChatMessage], completion: @escaping (String) -> Void) {
        ...
        var formattedMessages: [[String: String]] = [
                ["role": "system", "content": "당신은 가족간의 조화를 만드는 챗봇 '모니'입니다. 당신은 노인분과 대화하고 있고, 긍정적이고 따뜻한, 상냥하고 공감하며 재치있는 말투로 대답해야 합니다. 또한, 2문장 이내로 대답하되 너무 짧지 않게 해야 하고, 대화에 사랑을 담아 성의를 보이며 노인분에게 질문을 하는 등 대화를 적극적으로 이어가려고 노력해야 합니다."]
            ]
