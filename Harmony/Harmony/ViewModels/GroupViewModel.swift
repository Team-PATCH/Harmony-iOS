...
class FamilyInfoViewModel: ObservableObject {
    ...
    func fetchFamilyMembers() {
        // 가족구성원 불러오는 로직
        familyMembers = [
            FamilyMember(id: currentUser.id, user: currentUser, permissionId: UserRole(rawValue: userDefaultsManager.getPermissionId() ?? "") ?? .member, alias: userDefaultsManager.getAlias(), groupId: 1),
            FamilyMember(id: "user2", user: User(id: "user2", nick: "손녀 이지은"), permissionId: .member, alias: "손녀", groupId: 1),
            FamilyMember(id: "user3", user: User(id: "user3", nick: "손자 박준호"), permissionId: .vip, alias: "손자", groupId: 1)
        ]
    }
...
extension FamilyInfoViewModel {
    static func previewModel() -> FamilyInfoViewModel {
        ...
        model.familyMembers = [
            FamilyMember(id: "user1", user: model.currentUser, permissionId: .vip, alias: "할머니", groupId: 1),
            FamilyMember(id: "user2", user: User(id: "user2", nick: "손녀 이지은"), permissionId: .member, alias: "손녀", groupId: 1),
            FamilyMember(id: "user3", user: User(id: "user3", nick: "손자 박준호"), permissionId: .vip, alias: "손자", groupId: 1)
        ]
        return model
